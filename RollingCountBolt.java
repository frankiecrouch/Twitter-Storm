...
public class RollingCountBolt extends BaseRichBolt {
  ...
  @Override //Fields updated for this topology - this is the only change made to the code
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
    declarer.declare(new Fields("category", "count", "actualWindowLengthInSeconds"));
  }
